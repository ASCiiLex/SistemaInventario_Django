    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('inventory:movement_created', 'Movimiento'), ('inventory:stock_low', 'Stock bajo'), ('inventory:product_risk', 'Producto en riesgo'), ('orders:updated', 'Pedido')], db_index=True, max_length=50)),
